...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.server_last_modified'
        db.add_column(u'marathon_video', 'server_last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.server_last_modified'
        db.delete_column(u'marathon_video', 'server_last_modified')
