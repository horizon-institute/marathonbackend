...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContactRegistration'
        db.create_table(u'marathon_contactregistration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('registration_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'marathon', ['ContactRegistration'])


    def backwards(self, orm):
        # Deleting model 'ContactRegistration'
        db.delete_table(u'marathon_contactregistration')
