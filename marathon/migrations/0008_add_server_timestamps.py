...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PositionUpdate.server_created_date'
        db.add_column(u'marathon_positionupdate', 'server_created_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)

        # Adding field 'PositionUpdate.server_updated_date'
        db.add_column(u'marathon_positionupdate', 'server_updated_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)

        # Adding field 'RunnerTag.server_created_date'
        db.add_column(u'marathon_runnertag', 'server_created_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)

        # Adding field 'RunnerTag.server_updated_date'
        db.add_column(u'marathon_runnertag', 'server_updated_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)

        # Adding field 'Video.server_created_date'
        db.add_column(u'marathon_video', 'server_created_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)

        # Adding field 'Video.server_updated_date'
        db.add_column(u'marathon_video', 'server_updated_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)

        # Adding field 'Spectator.server_created_date'
        db.add_column(u'marathon_spectator', 'server_created_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)

        # Adding field 'Spectator.server_updated_date'
        db.add_column(u'marathon_spectator', 'server_updated_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PositionUpdate.server_created_date'
        db.delete_column(u'marathon_positionupdate', 'server_created_date')

        # Deleting field 'PositionUpdate.server_updated_date'
        db.delete_column(u'marathon_positionupdate', 'server_updated_date')

        # Deleting field 'RunnerTag.server_created_date'
        db.delete_column(u'marathon_runnertag', 'server_created_date')

        # Deleting field 'RunnerTag.server_updated_date'
        db.delete_column(u'marathon_runnertag', 'server_updated_date')

        # Deleting field 'Video.server_created_date'
        db.delete_column(u'marathon_video', 'server_created_date')

        # Deleting field 'Video.server_updated_date'
        db.delete_column(u'marathon_video', 'server_updated_date')

        # Deleting field 'Spectator.server_created_date'
        db.delete_column(u'marathon_spectator', 'server_created_date')

        # Deleting field 'Spectator.server_updated_date'
        db.delete_column(u'marathon_spectator', 'server_updated_date')
