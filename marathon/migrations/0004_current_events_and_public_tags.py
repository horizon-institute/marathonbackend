...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RunnerTag.public'
        db.add_column(u'marathon_runnertag', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'Event.is_current'
        db.add_column(u'marathon_event', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RunnerTag.public'
        db.delete_column(u'marathon_runnertag', 'public')

        # Deleting field 'Event.is_current'
        db.delete_column(u'marathon_event', 'is_current')
