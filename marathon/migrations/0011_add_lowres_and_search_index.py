...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.lowres_video_url'
        db.add_column(u'marathon_video', 'lowres_video_url',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Video.lowres_video_url'
        db.delete_column(u'marathon_video', 'lowres_video_url')
    ...
    models = {
        ...
        u'marathon.searchindex': {
            'Meta': {'object_name': 'SearchIndex'},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['marathon.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reference_index': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'result_count': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '300', 'db_index': 'True'}),
