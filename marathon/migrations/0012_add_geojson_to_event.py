...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'marathon_searchindex')

        # Adding field 'Event.geojson_url'
        db.add_column(u'marathon_event', 'geojson_url',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.latitude'
        db.add_column(u'marathon_event', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.longitude'
        db.add_column(u'marathon_event', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Event', fields ['name']
        db.create_unique(u'marathon_event', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Event', fields ['name']
        db.delete_unique(u'marathon_event', ['name'])

        # Adding model 'SearchIndex'
        db.create_table(u'marathon_searchindex', (
            ('reference_index', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=300, db_index=True)),
            ...
            ('result_count', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
        ))
        db.send_create_signal(u'marathon', ['SearchIndex'])

        # Deleting field 'Event.geojson_url'
        db.delete_column(u'marathon_event', 'geojson_url')

        # Deleting field 'Event.latitude'
        db.delete_column(u'marathon_event', 'latitude')

        # Deleting field 'Event.longitude'
        db.delete_column(u'marathon_event', 'longitude')
