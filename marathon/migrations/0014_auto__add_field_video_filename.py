...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'marathon_video', 'filename',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'marathon_video', 'filename')
    ...
    models = {
        ...
        u'marathon.video': {
            ...
            'filename': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '300', 'db_index': 'True', 'blank': 'True'}),
            'guid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
